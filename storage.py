...
DEFAULT_TOURNAMENT = {
    ...
    "num_courts": 1          # Number of courts available for simultaneous matches
}

def ensure_data_dir():
    """Create data directory if it doesn't exist.
    
    This ensures the data directory exists before attempting to read or write files.
...
def save_json(filename, data):
    ...
    with open(filepath, 'w', encoding='utf-8') as f:
        json.dump(data, f, indent=2, ensure_ascii=False)  # indent=2 for readable formatting
...
def get_teams():
    ...
    Returns:
        List of team dictionaries, each with 'id', 'player1', and 'player2' keys
    """
...
def get_matches():
    ...
    Returns:
        List of match dictionaries with match details (round, teams, scores, etc.)
    """
