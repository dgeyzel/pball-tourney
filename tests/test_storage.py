...
class TestJSONOperations:
    ...
    def test_load_json_returns_default_when_file_missing(self, temp_data_dir):
        """Test that load_json returns default value when file doesn't exist."""
        default = {"test": "value"}
...
class TestTournamentOperations:
    ...
    def test_get_tournament_returns_default_initially(self, temp_data_dir):
        """Test that get_tournament returns default when no tournament data exists."""
    ...
    def test_update_tournament_settings_preserves_other_fields(self, setup_test_data):
        """Test that update_tournament_settings preserves other tournament fields."""
