...
def create_handler(path, method='GET', post_data=None):
    ...
    # Create handler
    handler = server.TournamentHandler(mock_request, ('127.0.0.1', 8000), mock_server)
...
class TestPOSTEndpoints:
    ...
    def test_add_player_redirects(self, temp_data_dir):
        ...
        handler, response = create_handler('/add_player', 'POST', {'name': 'Test Player'})
    ...
    def test_add_team_redirects(self, setup_test_data):
        ...
        handler, response = create_handler('/add_team', 'POST', {'player1': '1', 'player2': '2'})
    ...
    def test_add_team_creates_team(self, setup_test_data):
        ...
        handler, response = create_handler('/add_team', 'POST', {'player1': '4', 'player2': '5'})
        handler.send_redirect = lambda x: None
        handler.do_POST()
    ...
    def test_add_team_rejects_same_player(self, setup_test_data):
        ...
        handler, response = create_handler('/add_team', 'POST', {'player1': '1', 'player2': '1'})
        handler.send_redirect = lambda x: None
        handler.do_POST()
    ...
    def test_update_settings_redirects(self, setup_test_data):
        ...
        handler, response = create_handler('/update_settings', 'POST', {'num_courts': '3'})
...
class TestHTMLRendering:
    ...
    def test_all_pages_include_navigation(self, setup_test_data):
        ...
        pages = ['/', '/settings', '/players', '/teams', '/matches', '/standings']
