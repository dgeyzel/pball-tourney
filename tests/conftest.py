...
@pytest.fixture
def setup_test_data(temp_data_dir, sample_players, sample_teams, sample_matches, sample_tournament):
...
def http_client():
    ...
    class TestClient:
        ...
        def start(self):
            ...
            self.server = socketserver.TCPServer(("", self.port), self.handler_class)
